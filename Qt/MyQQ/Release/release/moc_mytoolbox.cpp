...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MyToolBox_t, stringdata) + ofs \
...
const QMetaObject MyToolBox::staticMetaObject = {
    { &QToolBox::staticMetaObject, qt_meta_stringdata_MyToolBox.data,
      qt_meta_data_MyToolBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyToolBox.stringdata))
        return static_cast<void*>(const_cast< MyToolBox*>(this));
